...
namespace Lab_01_Zad_dodatkowe
{
    //----------============ Zad 01 ============----------↓
    public class Car
    {
    ...
    public class Person
    {
        private List<string> _registrationNumbers;
        ...
        public Person()
        {
            _registrationNumbers = new List<string>();
            _firstName = "none";
            _lastName = "none";
            _address = "none";
        }
        ...
        public Person(string firstName, string lastName, string address, Car[] cars)
        {
            ...
            if (cars.Length > 0 && cars.Length <= 3)
            {
                ...
                for (int i = 0; i < cars.Length; i++)
                {
                    if (cars[i] != null)
                    {
                        _registrationNumbers.Add(cars[i].RegistrationNumber);
                    }
                }
            }
        ...
        public int CarsCount
        {
            get { return _registrationNumbers.Count; }
        }
        ...
        public void AddCarRegistrationNumber(string registrationNumber)
        {
            ...
            {
                _registrationNumbers.Add(registrationNumber);
            }
        ...
        //    if (CarsCount > 0)
        //    {
        //        foreach (var regNumber in _registrationNumbers)
        //        {
        //            if (regNumber == registrationNumber)
        //            {
        //                _registrationNumbers.Remove(regNumber);
        //                break;
        //            }
        //        }
        //    }
        ...
        public void RemoveCarRegistrationNumber(string registrationNumber)
        {
            if (CarsCount > 0)
            {
                _registrationNumbers.Remove(registrationNumber);
            }
            else
            {
                Console.WriteLine("You don't have any cars to remove.");
